...
interface DragCard2Props extends React.Props<any>{
...
@DragSource(ItemTypes.TAB, cardSource, (connect, monitor) => ({
  connectDragSource: connect.dragSource(),
  //connectDragPreview: connect.dragPreview(),
  isDragging: monitor.isDragging()
}))
export default class DragCard2 extends React.Component<DragCard2Props, any> {
